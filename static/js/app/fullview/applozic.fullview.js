...
_this.sendVideoCallMessage = function(callId, msgType, contentType, audioOnly) {
        ...
        function MckMessageLayout() {
            ...
            var contactbox = '<li id="li-${contHtmlExpr}" class="person ${contIdExpr}" data-mck-id="${contIdExpr}" data-isgroup="${contTabExpr}" data-mck-conversationid="${conversationExpr}" data-msg-time="${msgCreatedAtTimeExpr}"><div class="mck-row">' + '<div class="blk-lg-3"><span class="">{{html contImgExpr}}</span></div>' + '<div class="blk-lg-9"><div class="mck-row"><div class="blk-lg-8 name">${contNameExpr}</div>' + '<div class="blk-lg-4 time mck-truncate">${msgCreatedDateExpr}</div></div>' + '<div class="mck-row"><div class="blk-lg-8 mck-cont-msg-wrapper preview msgTextExpr"></div>' + '<div class="blk-lg-4 mck-unread-count-box unreadcount ${contUnreadExpr}"><span class="mck-unread-count-text text">{{html contUnreadCount}}</span></div></div></div></div></div>' + '</li>';
            ...
            _this.getContactImageByAlphabet = function(name) {
                ...
                if (first_alpha.match(letters)) {
                    ...
                    return '<div data-v-58f33586="" class="avatar chat-avatar" style="width: 43px; height: 43px; border-radius: 50%; font-size: 30px; background-color: #fff; background-image: none;"><table data-v-58f33586=""><tr data-v-58f33586=""><td data-v-58f33586="">' + first_alpha + '</td></tr></table></div>'
        ...
        function MckContactService() {
            ...
            _this.loadUserProfile = function(userId) {
                if (typeof userId !== "undefined") {
                    var userIdArray = [];
                    var memberId = '' + userId.toString().split(",")[0];
